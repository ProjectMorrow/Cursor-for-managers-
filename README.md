...
APIs keys are encrypted using AES-256-GCM and stored securely within the macOS Keychain (utilizing the device's Secure Enclave).
...
Scope: * Fork AFFiNE and gut the document editor, leaving the React/Rust shell.
